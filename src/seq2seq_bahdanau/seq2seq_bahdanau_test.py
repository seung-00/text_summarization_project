...
# encoder1
encoder_model= tf.keras.models.load_model('/.../src/seq2seq_bahdanau/case1/encoder1.h5')
decoder_model= tf.keras.models.load_model('/.../src/seq2seq_bahdanau/case1/decoder1.h5', custom_objects={'AttentionLayer': AttentionLayer})

referenece_f1 = open("/.../data/bahdanau/case1/reference/reference.txt", mode = 'w')
system_f1 = open("/.../data/bahdanau/case1/system/system.txt", mode = 'w')
...
# encoder2
encoder_model= tf.keras.models.load_model('/.../src/seq2seq_bahdanau/case2/encoder2.h5')
decoder_model= tf.keras.models.load_model('/.../src/seq2seq_bahdanau/case2/decoder2.h5', custom_objects={'AttentionLayer': AttentionLayer})

referenece_f2 = open("/.../data/bahdanau/case2/reference/reference.txt", mode = 'w')
system_f2 = open("/.../data/bahdanau/case2/system/system.txt", mode = 'w')
...
# encoder3
encoder_model= tf.keras.models.load_model('/.../src/seq2seq_bahdanau/case3/encoder3.h5')
decoder_model= tf.keras.models.load_model('/.../src/seq2seq_bahdanau/case3/decoder3.h5', custom_objects={'AttentionLayer': AttentionLayer})

referenece_f3 = open("/.../data/bahdanau/case3/reference/reference.txt", mode = 'w')
system_f3 = open("/.../data/bahdanau/case3/system/system.txt", mode = 'w')
